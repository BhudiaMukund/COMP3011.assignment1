 ...
 *
 * Controllers depend on this rather than on a concrete
 * implementation. That single decision allows the cloud service
 * to be replaced by an in process stub during regression testing and offline
 * development, with no change to a calling code.
 */
